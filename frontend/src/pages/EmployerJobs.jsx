...
import { PlusCircle, Search, MapPin, DollarSign, Clock, Users, Trash2, Eye, Calendar } from 'lucide-react';
...
const EmployerJobCard = ({ job, onDelete }) => {
  ...
  const postedDate = job.postedAt ? new Date(job.postedAt).toLocaleDateString('en-IN', { day: 'numeric', month: 'short', year: 'numeric' }) : 'Today';
          ...
          <div className="flex justify-between items-end mb-8">
            <div>
              ...
              <p className="text-gray-500 mt-2 font-medium">
                Manage all the jobs you have posted. <span className="font-bold text-blue-600">{jobs.length} total</span>
              </p>
            </div>

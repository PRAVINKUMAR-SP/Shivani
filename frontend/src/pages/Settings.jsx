      ...
      <div className="flex-1 w-full flex flex-col relative z-20 h-full pt-8">
        <div className="px-4 sm:px-8 lg:px-12 pb-12 w-full max-w-4xl mx-auto flex-1 overflow-y-auto custom-scrollbar">
          <div className="mb-8">
            ...
            <p className="text-gray-500 mt-1 font-medium">Manage your preferences and account security</p>
          </div>
            ...
            <div className="space-y-6">
                ...
                <div className="p-6 space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">Receive emails about your application status</p>
                    </div>
                    <button 
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-gray-50">
                    ...
                    <button 
                      ...
                      className={`w-12 h-6 rounded-full transition-colors relative ${settings.jobRecommendations ? 'bg-blue-600' : 'bg-gray-200'}`}
                    >
                      <div className={`w-4 h-4 bg-white rounded-full absolute top-1 transition-transform ${settings.jobRecommendations ? 'translate-x-7' : 'translate-x-1'}`}></div>
                    </button>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <p className="text-sm text-gray-500 mb-4">Control who can see your profile and resume</p>
                  ...
                  >
                    ...
                    <option value="private">Private (Only visible to jobs you apply to)</option>
                  </select>
                </div>
              </div>

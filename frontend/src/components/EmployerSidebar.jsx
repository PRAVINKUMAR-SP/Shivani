...
const EmployerSidebar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar Container */}
      <div className={`
        fixed lg:sticky top-32 lg:top-24 left-0 z-[100] lg:z-30 h-[calc(100vh-128px)] lg:h-full w-64 bg-white dark:bg-slate-800 border-r border-gray-100 dark:border-slate-700 shadow-[4px_0_24px_rgba(0,0,0,0.02)] dark:shadow-none flex flex-col pt-8 pb-4
      ...
      <div className="px-4 mt-auto flex items-center">
        <button
          onClick={logout}
          className="flex items-center gap-3 px-4 py-3 rounded-xl transition-all w-full text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 font-semibold mt-4 border border-transparent hover:border-red-100 dark:hover:border-red-900/50 whitespace-nowrap"
        >

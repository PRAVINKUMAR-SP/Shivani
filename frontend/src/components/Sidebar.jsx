  ...
  return (
    <>
      ...
      <div className="px-4 mt-auto flex items-center">
        <button
          onClick={logout}
          className="flex items-center gap-3 px-4 py-3 rounded-xl transition-all w-full text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 font-semibold mt-4 border border-transparent hover:border-red-100 dark:hover:border-red-900/50 whitespace-nowrap"
        >
